...
const assets = [
  ...
  "./icons/icon-192.svg?v=162",
  "./icons/icon-512.svg?v=162",
  "./icons/icon-192.png?v=162",
  "./icons/icon-512.png?v=162",
  "./icons/apple-touch-icon.png?v=162",
];
