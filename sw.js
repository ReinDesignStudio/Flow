...
const assets = [
  ...
  "./icons/icon-192.svg?v=159",
  "./icons/icon-512.svg?v=159",
  "./icons/icon-192.png?v=159",
  "./icons/icon-512.png?v=159",
  "./icons/apple-touch-icon.png?v=159",
];
